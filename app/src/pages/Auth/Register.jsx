...
const RegisterPage = () => {
    return (
        <div className="relative flex items-center justify-center min-h-[calc(100vh-4rem)] p-4 overflow-hidden">
            ...
            <div className="absolute top-1/4 -right-20 w-72 h-72 bg-primary/20 rounded-full blur-3xl opacity-50" />
            <div className="absolute bottom-1/4 -left-20 w-72 h-72 bg-accent/20 rounded-full blur-3xl opacity-50" />

            <Card className="w-full max-w-md relative z-10 backdrop-blur-sm bg-card/80 border-border/50 shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-500">
